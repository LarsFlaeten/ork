...
class SceneGraphResourceExampleGLFW : public GlfwWindow
{
public:
    ...
    SceneGraphResourceExampleGLFW(const string &dir, const string &scene) :
...
static_ptr<Window> SceneGraphResourceExampleGLFW::app;

int sceneGraphResourceExampleGLFW(int argc, char* argv[])
{
    assert(argc > 3);
    atexit(Object::exit);
    SceneGraphResourceExampleGLFW::app = new SceneGraphResourceExampleGLFW(string(argv[2]), string(argv[3]));
    SceneGraphResourceExampleGLFW::app->start();
    return 0;
}

static MainFunction sceneGraphResourceMainGLFW("scenegraphresourceglfw", sceneGraphResourceExampleGLFW);
